...
const API_PRODUCTS_URL = `http://13.200.204.1/api/v1/products/`;
const API_CATEGORIES_URL = `http://13.200.204.1/api/v1/categories/`;
const API_SUBCATEGORIES_URL = `http://13.200.204.1/api/v1/subcategories/`;
